  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden sm:flex items-center space-x-2 text-sm text-gray-500">
              ...
              <span>{workspace.subscribers.length} online</span>
            </div>
      ...
      <div className="flex-1 flex min-h-0 relative">
        ...
        <div className="hidden lg:block w-64 bg-gray-50 border-l border-gray-200 p-4 flex-shrink-0">
        ...
        {showMembersSidebar && (
          <>
            ...
            />
            <div className="fixed top-0 right-0 bottom-0 w-80 bg-white border-l border-gray-200 p-4 z-50 lg:hidden">
